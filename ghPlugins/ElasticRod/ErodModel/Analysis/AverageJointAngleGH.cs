...
{
    public class AverageJointAngleGH : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AverageJointAngleGH()
          : base("Average Angle", "Average Angle",
            "Average joint angle of a RodLinkage.",
            "Erod", "Analysis")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            double ang = model.GetAverageJointAngle();

...
namespace ErodData.Data
{
    public class LTypeCSGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialData mat;
            if (pt == Point3d.Unset) mat = new MaterialData((int)CrossSectionType.L, orientation, sectionParams, e, nu);
            else mat = new MaterialData(pt, (int)CrossSectionType.L, orientation, sectionParams, e, nu);

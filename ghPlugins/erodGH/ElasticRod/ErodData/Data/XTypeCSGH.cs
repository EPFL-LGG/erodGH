...
namespace ErodData.Data
{
    public class XTypeCSGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialData mat;
            if (pt == Point3d.Unset) mat = new MaterialData((int)CrossSectionType.cross, orientation, sectionParams, e, nu);
            else mat = new MaterialData(pt, (int)CrossSectionType.cross, orientation, sectionParams, e, nu);

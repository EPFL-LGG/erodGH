...
void RodMaterial::setContourGH(Real E, Real nu, const std::vector<MeshIO::IOVertex > vertices,
                             const std::vector<MeshIO::IOElement> lines, const std::vector<Point2D> holePts, StiffAxis stiffAxis,
                             bool keepCrossSectionMesh, const std::string &debug_psi_path, Real triArea,
                             size_t simplifyVisualizationMesh /* = 0 */) 
{
    BBox<Point2D> bb(vertices);

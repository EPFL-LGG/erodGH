...
struct TargetSurfaceFitter {
    ...
    const Eigen::MatrixXd getTargetSurfaceVertices(){ return m_tgt_surf_V; }
    const Eigen::MatrixXi getTargetSurfaceFaces()   { return m_tgt_surf_F; }
    const Eigen::MatrixXd getTargetSurfaceNormals() { return m_tgt_surf_N; }

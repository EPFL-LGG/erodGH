...
struct WeavingOptimization : public LinkageOptimization<Object>{
    ...
    void constructTargetSurface(size_t loop_subdivisions = 0, Eigen::Vector3d scale_factors = Eigen::Vector3d(1, 1, 1)) {
        target_surface_fitter.constructTargetSurface(m_linesearch_base, loop_subdivisions, 2, scale_factors);
        invalidateAdjointState();
    }
...
private:
    ...
    bool m_updateAdjointState(const Eigen::Ref<const Eigen::VectorXd> &params, const OptEnergyType opt_eType=OptEnergyType::Full);

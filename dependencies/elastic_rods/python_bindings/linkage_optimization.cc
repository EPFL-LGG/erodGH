...
PYBIND11_MODULE(linkage_optimization, m) {
    ...
    using CFO_SAL = ContactForceObjective<SAL_T>;
    py::class_<CFO_SAL, DOOT_SAL, std::shared_ptr<CFO_SAL>>(m, "ContactForceObjective_SAL")
        .def(py::init<const SAL &>(), py::arg("surface_attracted_linkage"))
        .def_property(             "normalWeight", &CFO_SAL::getNormalWeight,              &CFO_SAL::setNormalWeight)
        .def_property(         "tangentialWeight", &CFO_SAL::getTangentialWeight,          &CFO_SAL::setTangentialWeight)
        .def_property(             "torqueWeight", &CFO_SAL::getTorqueWeight,              &CFO_SAL::setTorqueWeight)
        .def_property(     "boundaryNormalWeight", &CFO_SAL::getBoundaryNormalWeight,      &CFO_SAL::setBoundaryNormalWeight)
        .def_property( "boundaryTangentialWeight", &CFO_SAL::getBoundaryTangentialWeight,  &CFO_SAL::setBoundaryTangentialWeight)
        .def_property(     "boundaryTorqueWeight", &CFO_SAL::getBoundaryTorqueWeight,      &CFO_SAL::setBoundaryTorqueWeight)
        .def_property("normalActivationThreshold", &CFO_SAL::getNormalActivationThreshold, &CFO_SAL::setNormalActivationThreshold)
        .def("jointForces", [](const CFO_SAL &cfo) { return cfo.jointForces(); })
        ;

    using CFO_RL= ContactForceObjective<RodLinkage_T>;
    py::class_<CFO_RL, DOOT_RL, std::shared_ptr<CFO_RL>>(m, "ContactForceObjective_RL")
        .def(py::init<const RodLinkage &>(), py::arg("rod_linkage"))
        .def_property(             "normalWeight", &CFO_RL::getNormalWeight,              &CFO_RL::setNormalWeight)
        .def_property(         "tangentialWeight", &CFO_RL::getTangentialWeight,          &CFO_RL::setTangentialWeight)
        .def_property(             "torqueWeight", &CFO_RL::getTorqueWeight,              &CFO_RL::setTorqueWeight)
        .def_property(     "boundaryNormalWeight", &CFO_RL::getBoundaryNormalWeight,      &CFO_RL::setBoundaryNormalWeight)
        .def_property( "boundaryTangentialWeight", &CFO_RL::getBoundaryTangentialWeight,  &CFO_RL::setBoundaryTangentialWeight)
        .def_property(     "boundaryTorqueWeight", &CFO_RL::getBoundaryTorqueWeight,      &CFO_RL::setBoundaryTorqueWeight)
        .def_property("normalActivationThreshold", &CFO_RL::getNormalActivationThreshold, &CFO_RL::setNormalActivationThreshold)
        .def("jointForces", [](const CFO_RL &cfo) { return cfo.jointForces(); })
        ;

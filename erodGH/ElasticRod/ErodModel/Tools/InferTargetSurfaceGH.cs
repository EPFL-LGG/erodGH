...
{
    public class InferTargetSurfaceGH : GH_Component
    {
        ...
        /// </summary>
        public InferTargetSurfaceGH()
          : base("InferSurface", "InferSrf",
            "Construct a surface that best fits the RodLinkage.",
            "Erod", "Tools")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (constructionType != 0)
            {
                ...
                {
                    var splinesA = model.Layout.SplineBeamsA;
                    ...
                    var splinesB = model.Layout.SplineBeamsB;

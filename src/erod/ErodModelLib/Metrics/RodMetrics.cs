...
{
    public class RodMetrics : IGH_PreviewData, IGH_Goo
    {
        ...
        public RodMetrics(IEnumerable<ElasticRod> segments, SegmentMetricTypes sType, int alpha = 75)
        {
            SType = sType;
            Color[] colormap;
            int numSegments;
        ...
        public string TypeName => "RodMetrics";

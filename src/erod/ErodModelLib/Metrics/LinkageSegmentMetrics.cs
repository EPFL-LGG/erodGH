...
{
	public class LinkageSegmentMetrics : IGH_PreviewData, IGH_Goo
    {
        ...
        public LinkageSegmentMetrics(IEnumerable<RodSegment> segments, SegmentMetricTypes sType, int alpha = 75)
		{
            SType = sType;
            Color[] colormap;
            int numSegments;

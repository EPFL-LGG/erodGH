...
{
	public class LinkageStressesMetrics : IGH_PreviewData, IGH_Goo, IGH_BakeAwareData
    {
        ...
        public LinkageStressesMetrics(RodLinkage linkage, LinkageMetricTypes lType, ColorMapTypes cMap, int alpha, double lowerBound=default, double upperBound=default)
		{
            LTypes = lType;
        ...
        public string TypeName => "LinkageFieldMetrics";

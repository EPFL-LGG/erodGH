...
{
    public class eJointGH : GH_Component
    {
        /// <summary>
        ...
        public eJointGH()
          : base("eJoint", "eJoint",
            "Deconstruct a joint from a linkage.",
            "Erod", "Models")
        {
        }
        ...
        {
            pManager.AddGenericParameter("Joint", "Joint", "Joint from a linkage.", GH_ParamAccess.item);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.Resources.deconstruct_joint;
            }
        }

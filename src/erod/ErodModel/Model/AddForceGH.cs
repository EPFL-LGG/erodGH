...
{
    public class AddForceGH : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public AddForceGH()
          : base("AddForce", "AddForce",
            "Add forces to a RodLinkage model.",
            "Erod", "Model")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (model.ModelType != ModelTypes.RodLinkage) this.AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "The input model should be a RodLinkage. The current model is a " + model.ModelType.ToString());

            RodLinkage copy = (RodLinkage)model.Clone();
            for (int i = 0; i < forces.Count; i++) copy.AddForces(forces[i]);

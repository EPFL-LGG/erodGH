...
namespace ErodData.Materials
{
    public class ETypeCSGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialIO mat;
            if (pt == Point3d.Unset) mat = new MaterialIO((int)CrossSectionType.ellipse, orientation, sectionParams, e, nu);
            else mat = new MaterialIO(pt, (int)CrossSectionType.ellipse, orientation, sectionParams, e, nu);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Resources.cs_ellipse1;
            }
        }

...
{
    public class RTypeCSGH : GH_Component
    {
        int orientation;
        ...
        /// </summary>
        public RTypeCSGH()
          : base("Rectangular-Shape", "Rectangular-Shape",
              "Build a cross-section using a rectangular profile.",
              "Erod", "Materials")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialIO mat;
            if (pt == Point3d.Unset) mat = new MaterialIO((int)CrossSectionType.rectangle, orientation, sectionParams, e, nu);
            else mat = new MaterialIO(pt, (int)CrossSectionType.rectangle, orientation, sectionParams, e, nu);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Resources.cs_rectangle1;
            }
        }
        ...
        {
            get { return new Guid("1c4b8a91-6918-4c3a-acaa-68b680bd4a9d"); }
        }
    }
}

...
{
    public class CTypeCSGH : GH_Component
    {
        int orientation;
        ...
        /// </summary>
        public CTypeCSGH()
          : base("Custom-Shape", "C-Shape",
              "Build a cross-section using a custom profile.",
              "Erod", "Materials")
        {
        }
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddCurveParameter("Contour", "Contour", "Contour profile.", GH_ParamAccess.item);
            pManager.AddNumberParameter("Scale", "Scale", "Scaling factor.", GH_ParamAccess.item, 1.0);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (e <= 0 || nu <= 0 || scale <= 0) AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Invalid material parameters.");
            if(!crv.IsPolyline() || !crv.IsClosed) AddRuntimeMessage(GH_RuntimeMessageLevel.Error, "Contour should be a closed polyline.");

            Polyline poly;
            crv.TryGetPolyline(out poly);
            MaterialIO mat;
            if (pt == Point3d.Unset) mat = new MaterialIO(poly, e, nu, scale);
            else mat = new MaterialIO(pt, poly, e, nu, scale);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Resources.cs_custom1;
            }
        }
        ...
        {
            get { return new Guid("3fc1db3e-060a-4d97-a262-2814d6dbe473"); }
        }
    }
}

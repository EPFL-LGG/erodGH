...
{
    public class LTypeCSGH : GH_Component
    {
        //   h2
        //  +---+
        //  |   |
        ...
        /// </summary>
        public LTypeCSGH()
          : base("L-Shape", "L-Shape",
              "Build a cross-section using an L profile.",
              "Erod", "Materials")
        {
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialIO mat;
            if (pt == Point3d.Unset) mat = new MaterialIO((int)CrossSectionType.L, orientation, sectionParams, e, nu);
            else mat = new MaterialIO(pt, (int)CrossSectionType.L, orientation, sectionParams, e, nu);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Resources.cs_L1;
            }
        }
        ...
        {
            get { return new Guid("ab4c218c-04f0-4d91-8418-a7af21fccbe8"); }
        }
    }
}

...
namespace ErodData.Data
{
    public class ITypeCSGH : GH_Component
    {
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            MaterialData mat;
            if(pt==Point3d.Unset) mat = new MaterialData((int) CrossSectionType.I, orientation, sectionParams, e, nu);
            else mat = new MaterialData(pt, (int)CrossSectionType.I, orientation, sectionParams, e, nu);

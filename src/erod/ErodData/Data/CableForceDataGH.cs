...
{
    public class CableForceDataGH : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the ForceVectorGH class.
        /// </summary>
        public CableForceDataGH()
          : base("Cable", "Cable",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddNumberParameter("Diamater", "Diamater", "Diamaeter of the cable.", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            CableForceData force = new CableForceData(e, E, area, restLength);

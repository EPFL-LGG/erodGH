...
namespace ErodData.IO
{
    public class DeconstructJointGH : GH_Component
    {
        ...
        public DeconstructJointGH()
          : base("eJointIO", "eJointIO",
            "Deconstruct JointIO data.",
            "Erod", "IO")
        {
        }
        ...
        {
            pManager.AddGenericParameter("JointIO", "JointIO", "JointIO to deconstruct.", GH_ParamAccess.item);
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Properties.Resources.Resources.joint_data_deconstruct;
            }
        }
